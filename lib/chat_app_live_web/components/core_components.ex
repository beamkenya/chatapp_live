defmodule ChatAppLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChatAppLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChatAppLiveWeb.Gettext, "errors", msg, opts)
    end
  end
